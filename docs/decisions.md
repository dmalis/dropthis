...
75. **Six rulings the keys slice needed (issue #7).** All are choices the spec left open;
...
76. **Eight rulings the expiry/password/cron slice needed (issue #6).** All are choices the
    spec left open.
